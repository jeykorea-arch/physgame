    ...
    stages: [
      {
        ...
        observeText: "네 개의 다이오드 회로에서는 입력 전류의 방향이 바뀔 때마다 전류가 지나는 두 다이오드가 바뀝니다. 출력 전류는 계속 같은 방향으로 흐릅니다.",
        prediction: "입력 전류가 +방향인 순간 전류가 지나는 다이오드는 무엇일까요?",
        predictionOptions: ["D1과 D4", "D2와 D3", "D1과 D2"], predictionAnswer: "D1과 D4",
        sliderLabel: "입력 전류의 변화 단계 θ", sliderMin: 0, sliderMax: 360, sliderStep: 30, sliderDefault: 60, sliderUnit: "°",
        manipulationNote: "입력 전류의 방향이 바뀌면 다른 두 다이오드를 지나지만, 출력 전류는 계속 같은 방향으로 흐릅니다.",
      },
      {
