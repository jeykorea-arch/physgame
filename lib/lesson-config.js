...
export const LESSONS = {
  ...
  2: {
    number: 2,
    title: "콘센트에서 충전기로",
    story: "가정에 도착한 교류를 스마트폰이 사용할 수 있는 제어된 직류로 바꿉니다.",
    outcome: "다이오드는 전류 방향을 한쪽으로 정류하고, 축전기는 전압 골짜기를 메워 리플을 줄이며, 트랜지스터는 에너지 흐름을 빠르게 스위칭한다.",
    teacherTopics: ["브리지 정류 두 경로", "맥동 직류", "축전기 충·방전과 리플", "스위칭 손실과 충전기 실제 순서"],
    stages: [
      {
        number: "04", name: "다이오드 정류", markers: [marker("04", "다이오드 정류", 3)], questions: [0, 1, 2, 3, 4], visualType: "rectifier",
        observeTitle: "두 경로로 방향을 한쪽으로",
        observeText: "브리지 정류기에서는 입력 극성이 바뀔 때마다 두 다이오드가 번갈아 도통하여 부하 전류의 방향을 DC+에서 DC-로 유지합니다.",
        prediction: "왼쪽 AC 단자가 오른쪽보다 높은 순간 도통하는 경로는 무엇일까요?",
        predictionOptions: ["D1과 D4", "D2와 D3", "D1과 D2"], predictionAnswer: "D1과 D4",
        sliderLabel: "교류 입력 위상", sliderMin: 0, sliderMax: 360, sliderStep: 30, sliderDefault: 60, sliderUnit: "°",
        manipulationNote: "0~179°는 D1·D4, 180~359°는 D2·D3가 도통합니다. 부하 전류 방향은 같습니다.",
      },
      {
        number: "05", name: "축전기 평활", markers: [marker("05", "축전기 평활", 4)], questions: [5, 6], visualType: "smoothing",
        observeTitle: "전압 골짜기를 메우는 저장",
        observeText: "축전기는 파형 꼭대기 부근에서 충전되고 입력이 낮아질 때 부하로 방전하여 골짜기를 메웁니다. 리플을 줄이지만 완전히 없애지는 않습니다.",
        prediction: "부하와 주파수가 같을 때 축전기 용량을 작게 만들면 리플은 어떻게 될까요?",
        predictionOptions: ["커진다", "작아진다", "항상 0이다"], predictionAnswer: "커진다",
        sliderLabel: "평활 축전기 용량 C", sliderMin: 100, sliderMax: 1000, sliderStep: 100, sliderDefault: 500, sliderUnit: " μF",
        manipulationNote: "같은 부하에서 용량이 클수록 방전 중 전압 감소가 작아 리플이 줄어듭니다.",
      },
      {
        number: "06", name: "트랜지스터 스위칭", markers: [marker("06", "트랜지스터 스위칭", 5)], questions: [7, 8, 9], visualType: "switching",
        observeTitle: "에너지 흐름을 빠르게 켜고 끄기",
        observeText: "트랜지스터는 외부 전원에서 오는 에너지 흐름을 빠르게 ON/OFF합니다. 이상적인 ON은 전압 강하가 작고 OFF는 전류가 작아 평균 발열 손실을 줄일 수 있습니다.",
        prediction: "선형 중간 상태에 오래 머무는 것보다 빠른 ON/OFF가 효율적인 까닭은 무엇일까요?",
        predictionOptions: ["큰 전압과 큰 전류가 동시에 걸리는 시간을 줄인다", "에너지를 새로 만든다", "모든 저항을 0으로 만든다"], predictionAnswer: "큰 전압과 큰 전류가 동시에 걸리는 시간을 줄인다",
        sliderLabel: "스위칭 듀티비", sliderMin: 10, sliderMax: 90, sliderStep: 10, sliderDefault: 50, sliderUnit: "%",
        manipulationNote: "듀티비는 한 주기 중 ON 시간의 비율입니다. 실제 출력은 피드백 제어와 함께 결정됩니다.",
      },
    ],
  },
  3: {
    ...
    outcome: "전력망에서는 전압을 높이고 낮추며, 충전기에서는 전류 방향을 한쪽으로 만들고 전압 골짜기를 메운 뒤 스위칭과 피드백으로 출력을 조절한다.",
    teacherTopics: ["고장별 파형 변화", "V²/R에서 V의 대상", "전력망과 충전기 내부 변압 구분", "최종 개념 지도"],
    stages: [
      {
        number: "A", name: "부품 고장 수사", markers: [marker("04", "다이오드 정류", 3), marker("05", "축전기 평활", 4), marker("06", "트랜지스터 스위칭", 5)], questions: [0, 1, 2], visualType: "faults",
        observeTitle: "고장 부품이 남기는 파형 단서",
        observeText: "다이오드 단선은 반주기 경로를 잃게 하고, 축전기 제거는 리플을 키우며, 트랜지스터 고정 ON은 제어와 보호를 무너뜨릴 수 있습니다.",
        prediction: "평활 축전기가 회로에서 빠지면 가장 먼저 커지는 것은 무엇일까요?",
        predictionOptions: ["출력 리플", "축전기 용량", "송전 전압"], predictionAnswer: "출력 리플",
        sliderLabel: "결함 로그", sliderMin: 1, sliderMax: 3, sliderStep: 1, sliderDefault: 1, sliderUnit: "번",
        manipulationNote: "1 다이오드 단선 · 2 축전기 제거 · 3 트랜지스터 ON 고정의 예상 파형과 위험을 비교합니다.",
      },
      {
      ...
      {
        number: "C", name: "전체 여정 복원", markers: [marker("01", "발전소", 0), marker("06", "트랜지스터 스위칭", 5)], questions: [6, 7, 8, 9], visualType: "journey",
        observeTitle: "높이고·낮추고·한쪽으로·메우고·조절하기",
        observeText: "전력망의 변압과 충전기 내부 전력 변환은 위치와 역할이 다릅니다. 파형의 방향, 리플, 제어 상태를 기준으로 전체 여정을 연결합니다.",
        prediction: "정류 직후와 평활 후를 구분하는 가장 직접적인 파형 단서는 무엇일까요?",
        predictionOptions: ["리플의 크기", "송전탑의 높이", "발전기 회전자 수"], predictionAnswer: "리플의 크기",
        sliderLabel: "에너지 여정 단계", sliderMin: 1, sliderMax: 5, sliderStep: 1, sliderDefault: 1, sliderUnit: "/5",
        manipulationNote: "1 발전 · 2 고전압 송전/강압 · 3 정류 · 4 평활 · 5 스위칭/출력 제어를 연결합니다.",
      },
    ],
  },
};
