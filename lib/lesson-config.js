    ...
    stages: [
      {
        ...
        manipulationNote: "전류 경로를 분명히 보여 주는 이상적 다이오드 모형입니다. θ(위상각)는 교류 한 주기 0°~360°에서 현재 순간의 위치입니다. θ를 옮겨 입력 A/B 중 어디에서 시작하고 어느 다이오드와 전류계를 지나는지 따라가 보세요. 부하의 출력 전류 방향은 항상 위에서 아래로 같습니다.",
      },
      {
        number: "05", name: "축전기의 충전과 방전", markers: [marker("05", "축전기의 충전과 방전", 4)], questions: [5, 6], visualType: "smoothing",
        observeTitle: "출력 전압의 출렁임 줄이기",
        observeText: "정류된 입력 전압이 축전기 전압보다 높아질 때 축전기가 충전됩니다. 정류 전압이 다시 낮아지면 축전기가 부하로 전하를 내보내 출력 전압이 급격히 낮아지는 것을 막습니다. 출렁임은 줄지만 완전히 사라지지는 않습니다.",
        ...
        manipulationNote: "부하와 입력 주파수가 같은 조건입니다. 같은 전하량이 이동할 때 ΔV≈ΔQ/C이므로 전기 용량 C가 클수록 축전기 전압의 변화가 작아집니다.",
      },
      {
        ...
        observeText: "트랜지스터는 외부 전원에서 오는 전류의 경로를 빠르게 열고 닫는 스위치로 동작할 수 있습니다. 실제 충전기는 코일·변압기·축전기·보호 회로와 함께 전압과 전류를 안전하게 바꿉니다.",
        ...
        manipulationNote: "입력과 부하가 같은 이상적 개념 모형에서는 한 주기 중 트랜지스터가 켜진 시간의 비율이 커질수록 상대 전달량이 커집니다. 실제 충전기의 출력은 이 비율 하나만으로 결정되지 않습니다.",
      },
    ],
  },
  3: {
    ...
    stages: [
      ...
      },
      {
        ...
        manipulationNote: "1 터빈의 에너지를 전기 에너지로 전환 · 2 전압을 높여 송전한 뒤 낮춤 · 3 한 방향 전압 만들기 · 4 출력 전압 변화 줄이기 · 5 전류 조절을 연결합니다.",
      },
    ],
  },
};
